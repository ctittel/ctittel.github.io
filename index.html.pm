...
Before that, I received a Bachelor's in Mechatronics from Nuremberg Institute of Technology. My Bachelor studies were organized in the form of a dual studies program (◊i{Verbundstudium}) in cooperation with Siemens and included a practical training and internships at Siemens.
...
◊ul{
    ◊li{◊b{Artificial Intelligence}: Currently, I prefer AI approaches which make no "explicit" use of statistics. My current belief is that the most promising approach towards ◊hyperlink["https://en.wikipedia.org/wiki/Artificial_general_intelligence"]{AGI} is the combination of a Machine Learning approach like Deep Learning plus some sort of genetic approach like ◊hyperlink["https://geneticprogramming.com"]{Genetic Programming}.}
    ◊li{◊b{◊hyperlink["https://en.wikipedia.org/wiki/Information_design"]{Information Design}}: Information Design wants to answer the question of how we can present information (mostly visual information like text and images) so that it can be absorbed as easily as possible by other humans, taking human psychology and cognition into account. One of the key scientists in this field is Edward Tufte, who describes many ◊hyperlink["https://www.edwardtufte.com/tufte/"]{interesting insights} about this field. A nice example for Information Design, and an easy way to use the results of the field in a website, is ◊hyperlink["https://edwardtufte.github.io/tufte-css/"]{tufte-css}.}
    ◊li{◊b{Programming Languages}: I enjoy learning about new programming languages and how they compare to existing ones. Also, I am curious towards which programming languages humanity will "converge" in the long term. An apparently often underestimated factor in newer programming languages is their UX and the ◊hyperlink["https://en.wikipedia.org/wiki/Psychology_of_programming"]{Psychology of Programming}.}
}
